		...
		<div id="noticedetail">
			...
			<% LMS_Notice_Dto bean=(LMS_Notice_Dto)request.getAttribute("bean"); %>
				<thead>
					<tr>
						<th>제목</th>
						<td class="title" colspan="3"><%=bean.getNottitle() %></td>
					</tr>
					<tr>
						<th>작성자</th>
						<td colspan="3">관리자</td>
					...
					<tr>
						<th>작성일</th>
						<td><%=bean.getNotdate() %></td>
						<th>조회수</th>
						<td style="width:100px; text-align: center; padding: 0px;"><%=bean.getCnt() %></td>
					</tr>
				</thead>
				<tbody>
					<tr>
						<td colspan="4" >
							<textarea class="textarea" readonly="readonly"><%=bean.getNotcontent() %></textarea>
						</td>	
					</tr>
				</tbody>
			</table>
