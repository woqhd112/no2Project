			...
			<ul class="mainbox">
				...
				<li>
					...
					<c:forEach items="${alist }" var="bean">
						<div id="regnottitle">
							<a style="text-align: left; padding-left:20px;" href="${root }LMS/Sales/regnot_detail.html?num=${bean[1].regnum}&cnt=${bean[1].regcnt}">${bean[0].classname }</a>
						</div>
					</c:forEach>
					...
					<div id="page" style="margin-top:-10px;">
						...
						<%		}else{ %>
							<a class="page" href="${root }LMS/Sales/regnot.html?page=<%=i %>">&nbsp;<%=i %>&nbsp;</a>
						<%		}}
							if(next==true){	
						%>
							<a class="prnx" href="${root }LMS/Sales/regnot.html?page=<%=end+1 %>">＞</a>
						<%} 
						%>
					</div>
					</div>
