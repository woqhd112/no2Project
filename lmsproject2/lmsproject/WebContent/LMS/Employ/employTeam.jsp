				...
				<ul class="mainbox">
					...
					<li>
						<div id="info">
							...
							<%		}else{ %>
								<a class="page" href="${root }LMS/Employ/employTeam.html?page=<%=i %>&search=<%=search%>&keyword=<%=keyword%>">&nbsp;<%=i %>&nbsp;</a>
							<%		}}
								if(next==true){	
							%>
								<a class="prnx" href="${root }LMS/Employ/employTeam.html?page=<%=end+1 %>&search=<%=search%>&keyword=<%=keyword%>">＞</a>
							<%} 
							%>
							</div>
							<div id="search">
