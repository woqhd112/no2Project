	...
	<div class="wow fadeInUp">
		<div class="lms">
			...
			<div class="box">
				...
				<ul class="mainbox">
					<li class="title" style="margin-top:50px; margin-bottom:10px">채용정보</li>
					<li>
						<input style=" margin-bottom: 20px;" class="addbtn" type="button" onclick="location.href='./employ_insert.html'" value="등록">
					</li>
					<li>
						<div id="employ">
							<table>
