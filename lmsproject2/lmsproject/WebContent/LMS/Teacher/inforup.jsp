...
%>
	$(document).ready(function(){
		...
		$('#headerBtn a:nth-child(2)').on("click", function () {
			return false;
		});
		...
		$('.btn').click(function(){
			 ...
			 if(con){
				 ...
				 $.post('${root }LMS/Teacher/inforup.html','empnum='+<%=login.getEmpnum()%>+'&emppw='+$('#edit1').val()+'&empemail='+$('#edit2').val()+'&empphone='+$('#edit3').val()+'&empaddr='+$('#edit4').val(),function(data){
					 if(data==ok){
	...
	<div class="lms">
		<div class="conHeader">
			...
			<div id="headerBtn">
				...
				<a style="cursor: default; font-weight: bold;" href="${root }LMS/Teacher/inforup.html">정보수정</a>
