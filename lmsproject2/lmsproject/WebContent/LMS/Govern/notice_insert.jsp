...
<form method="post">
	<div class="lms">
		...
		<div class="box">
			...
			<ul class="mainbox">
				<li class="title" style="margin-top:50px; margin-bottom:50px; text-align: center;">공지사항 등록</li>	
				<li>
					<div id="noticedetail"> 
						<table>
							<thead>
								<tr>
									...
									<td class="title" colspan="3">
										<input id="newTitle" type="text" value="" style="padding-left: 10px; width: 96%; height:30px" name="nottitle"/>
									</td>
								</tr>
								<tr>
									<th colspan="4" style="width:100%; text-align: left; padding-left: 31px;">내용</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td colspan="4" >
										<textarea class="textarea2" name="notcontent"></textarea>
									</td>	
								</tr>
							</tbody>
						</table>
					</div>
					<input type="hidden" name="notauthor" value="관리자" />
					<div class="btnbox">
						<button class="btn1" type="submit">등록</button>
						<button class="btn2" type="button" onclick="window.history.back()">뒤로</button>
					</div>
				</li>
			</ul>
		</div>
