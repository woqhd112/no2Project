					...
					<div id="notice">
						<table>
							...
							<c:forEach items="${alist }" var="bean">
								<tr>
									<td>${bean.faqnum }</td>
									<td style="width:50%"><a href="${root }LMS/Govern/faq_detail.html?num=${bean.faqnum}">${bean.faqtitle }</a></td>
									<td>${bean.faqdate }</td>
								</tr>
							</c:forEach>	
							</tbody>
						...
						<div id="page">
								<%
									...
									if(prev==true){
								%>
									<a class="prnx" href="${root }LMS/Govern/faq.html?page=<%=begin-5 %>">＜</a>
								<%	}
								...
								<%		}else{ %>
									<a class="page" href="${root }LMS/Govern/faq.html?page=<%=i %>">&nbsp;<%=i %>&nbsp;</a>
								<%		}}
									if(next==true){	
								%>
									<a class="prnx" href="${root }LMS/Govern/faq.html?page=<%=end+1 %>">＞</a>
								<%} 
								%>
						</div>
					</div>
