	...
	<div class="wow fadeInUp">
		<div class="lms">
			...
			<div class="box">
				...
				<ul class="mainbox">
					<li class="title" style="margin-top:50px; margin-bottom:10px">교직원 관리</li>	
					<li>
					...
					<li>
						<div id="info">
							...
							<% Paging paging = (Paging)request.getAttribute("paging");
								...
								if(prev==true){
							%>
								<a class="prnx" href="${root }LMS/Govern/staffAdmin.html?page=<%=begin-10 %>&search=<%=search%>&keyword=<%=keyword%>">＜</a>
							<%	}
							...
							<div id="search">
								<form action="${root }LMS/Govern/staffAdmin.html">
									...
									<input class="searchbtn" type="submit" value="검색">
			              			<input class="resetbtn" type="button" onclick="location.href='./staffAdmin.html'" value="초기화">
								</form>
							</div>
						</div>
					</li>
