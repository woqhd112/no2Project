...
@WebServlet("/LMS/Teacher/teacherTeam.html")
public class TeacherTeamController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
			...
			String tablename = "emp1";
				try {
					...
					System.out.println("강사팀 교직원조회 화면출력-테이블갯수 에러");
			...
			try{
				...
				System.out.println("강사팀 교직원조회 화면출력 에러");
				resp.sendRedirect("../lmsLogin.html");
				req.getSession().setAttribute("lmslogin", null);
				return;
			
			}
		req.getRequestDispatcher("teacherTeam.jsp").forward(req, resp);
	}
}
