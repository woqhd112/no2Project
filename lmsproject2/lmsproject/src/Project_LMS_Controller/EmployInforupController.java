...
@WebServlet("/LMS/Employ/inforup.html")
public class EmployInforupController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("취업팀 정보수정 화면출력 에러");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp)
		...
		try {
			...
			System.out.println("취업팀 정보수정 수정작업 에러");
			out.print("fail1");
			out.flush();
			out.close();
		}
