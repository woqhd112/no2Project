...
@WebServlet("/LMS/Employ/employTeam.html")
public class EmployTeamController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String tablename = "emp1";
			try {
				...
				System.out.println("취업팀 교직원등록 화면출력-테이블갯수 에러");
		...
		try{
			...
			System.out.println("취업팀 교직원정보 화면출력 에러");
			resp.sendRedirect("../lmsLogin.html");
			req.getSession().setAttribute("lmslogin", null);
			return;
		}
		req.getRequestDispatcher("employTeam.jsp").forward(req, resp);
	}
}
